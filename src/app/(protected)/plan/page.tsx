          ...
          {plans.map((plan) => (
            <Card
              ...
              className={`p-6 relative ${
                plan.recommended ? 'border-primary-desktop ring-2 ring-primary-desktop' : ''
              }`}
            >
              {plan.recommended && (
                <div className="absolute -top-3 left-1/2 -translate-x-1/2 px-3 py-1 bg-primary-desktop text-white text-xs font-medium rounded-full">
                  추천
                </div>
              )}

              <div className="mb-4">
                <h3 className="text-lg font-semibold text-primary-desktop">
                  {plan.name}
                </h3>
