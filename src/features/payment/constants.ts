...
export const PACKAGES: Package[] = [
  {
    ...
    themeCount: 1,
    features: [
      { icon: 'Image', text: '화보 12장 생성' },
      { icon: 'RotateCcw', text: '재생성 1회' },
    ],
    recommended: false,
  },
  {
    ...
    themeCount: 3,
    features: [
      { icon: 'Image', text: '화보 36장 생성' },
      { icon: 'RotateCcw', text: '재생성 3회' },
      { icon: 'Palette', text: '3개 테마 선택 가능' },
    ],
    recommended: true,
  },
  {
    ...
    themeCount: 5,
    features: [
      { icon: 'Image', text: '화보 60장 생성' },
      { icon: 'RotateCcw', text: '재생성 5회' },
      { icon: 'Palette', text: '5개 테마 선택 가능' },
      { icon: 'Crown', text: '프리미엄 보정' },
    ],
    recommended: false,
  },
];
